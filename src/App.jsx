...
const saveKey = 'hobby-stock-price-alert.saved'
const postKey = 'hobby-stock-price-alert.posts'
const alerts = [
  {
    "id": "hobby-stock-price-alert-1",
    "title": "在庫復活 alert seed 1",
    "area": "名古屋",
    "category": "在庫復活",
    "score": 95,
    "summary": "在庫復活、価格下落、予約開始、再販を通知し、ECアフィリエイトと有料通知へつなげる。 在庫復活の条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X"
    ],
    ...
    "revenue": "EC affiliate"
  },
  {
    "id": "hobby-stock-price-alert-2",
    "title": "価格下落 alert seed 2",
    "area": "東京",
    "category": "価格下落",
    "score": 92,
    "summary": "在庫復活、価格下落、予約開始、再販を通知し、ECアフィリエイトと有料通知へつなげる。 価格下落の条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X",
      "メール"
  ...
  {
    "id": "hobby-stock-price-alert-3",
    "title": "予約開始 alert seed 3",
    "area": "大阪",
    "category": "予約開始",
    "score": 89,
    "summary": "在庫復活、価格下落、予約開始、再販を通知し、ECアフィリエイトと有料通知へつなげる。 予約開始の条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X",
      "メール",
  ...
  {
    "id": "hobby-stock-price-alert-4",
    "title": "再販 alert seed 4",
    "area": "静岡",
    "category": "再販",
    "score": 86,
    "summary": "在庫復活、価格下落、予約開始、再販を通知し、ECアフィリエイトと有料通知へつなげる。 再販の条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X"
    ],
  ...
  return (
    <main className="app-shell">
      <section className="hero">
        <div>
          <p className="eyebrow">フィギュア・トレカ・ゲーム在庫/価格通知</p>
          <h1>Hobby Stock Price Alert</h1>
          <p className="lead">在庫復活、価格下落、予約開始、再販を通知し、ECアフィリエイトと有料通知へつなげる。</p>
        </div>
        <aside className="hero-panel">
          <span>hobbystock.jp / hobby-stock-price-alert</span>
